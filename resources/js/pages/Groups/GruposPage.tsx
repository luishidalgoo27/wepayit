...
export const GruposPage = () => {
    return (
        <main className="min-h-screen bg-gradient-to-b from-[#00110F] to-[#164236] flex justify-center py-10  container mx-auto p-4">
            <div className="w-11/12 max-w-md space-y-4">
                <Link to="/gastos" className="bg-[#D5F3EA] text-black rounded-xl flex items-center p-4 shadow-md">
                    <div>
                ...
                <Link to="/crearGrupo" className="block text-center bg-[#D5F3EA] text-black hover:bg-[#b9e6d8] rounded-xl py-3 mt-2 shadow-md font-semibold transition">
                    + Crear nuevo grupo
                </Link>
            </div>
        </main>
